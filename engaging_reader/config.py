...
SUPPORTED_I18N_LANGS = frozenset({
    "en", "es", "fr", "uk", "fil", "tr", "pt", "pa", "zh", "ru", "ht",
    "ar", "he", "ur", "fa", "prs",
})
...
SITE_FEATURES = (
    ...
    "Multilingual interface: English, Spanish, French, Filipino, Portuguese, Punjabi, Turkish, Ukrainian, Russian, Haitian Creole, Chinese, Arabic, Hebrew, Urdu, Farsi, and Dari",
)
